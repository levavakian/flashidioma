...
- **Tests:**
  - [ ] Unit: auto-added conjugation card starts as 'new' by default
  - [ ] Unit: auto-added conjugation card starts as 'learning' when `conjugationCardsStartLearning` is true
  - [x] Unit: auto-added conjugation card does not increment daily new card count
  - [ ] Unit: with `conjugationCardsStartLearning`, auto-added card appears in `getDueCards` (not filtered by new-card gate)
